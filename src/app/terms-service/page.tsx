  ...
  return (
    <MaxWidthWrapper className="my-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl p-6 border border-gray-200 rounded-md">
        ...
        <p className="text-gray-700 mb-4">
          By accessing and using TiteL.io, you accept and agree to be bound by
        ...
        <p className="text-gray-700 mb-4">
          ...
          without prior notice. Your continued use of the service following the
        ...
        <p className="text-gray-700 mb-4">
          ...
          TiteL.io. You may not reproduce, republish, distribute, or otherwise
          use any of the content without our express written consent.
        </p>
