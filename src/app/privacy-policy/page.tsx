      ...
      <div className="mx-auto max-w-4xl p-6 border border-gray-200 rounded-md text-left">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 text-left mx-auto max-w-3xl">
          ...
          <li>
            ...
            such as pages visited, time spent on the site, and links clicked.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4 text-left mx-auto max-w-3xl">
          <li>
            Provide and improve our services, including generating SEO-friendly
            titles for your content.
          </li>
        ...
        <p className="text-gray-700 mb-4">
          ...
          please contact us at: support@titel.io
        </p>

        <p className="text-gray-700">Effective Date: 6/4/2024</p>
      </div>
    </MaxWidthWrapper>
  );
};
